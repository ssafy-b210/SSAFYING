...
public class MypageController {
    ...
    public ResponseEntity<ResultResponse<FindMypageResponse>> mypageDetails(@PathVariable int userId) {
    ...
    public ResponseEntity<ResultResponse<List<HashtagDto>>> UsedHashtagsList(@PathVariable int userId) {
    ...
    public ResponseEntity<ResultResponse<List<GetFeedResponse>>> AuthoredBoardList(@PathVariable int userId) {
    ...
    public ResponseEntity<ResultResponse<List<GetFeedResponse>>> ScrapBoardList(@PathVariable int userId) {
    ...
    public ResponseEntity<ResultResponse<List<PortfolioDto>>> portfolioList(@PathVariable int userId) {
    ...
    public ResponseEntity<ResultResponse<Long>> portfolioAdd(@PathVariable int userId,
    ...
    public ResponseEntity<ResultResponse<Long>> portfolioModify(@PathVariable int portfolioId,
                                                                @RequestBody @Valid SavePortfolioRequest request) {
    ...
    public ResponseEntity<ResultResponse<Integer>> portfolioRemove(@PathVariable int portfolioId) {
